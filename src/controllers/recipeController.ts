...
class RecipeController {
    ...
    public async getAllRecipes(req: any, res: any) {
        try {
            const recipes = await recipeService.getAllRecipes(req.query.page, req.query.limit);
    ...
    public async createRecipe(req: any, res: any) {
        try {
            const recipe = await recipeService.createRecipe(req.user.id, req.body.title, req.body.body)
    ...
    public async updateRecipe(req: any, res: any) {
        try {
            const recipe = await recipeService.updateRecipe(req.params.id, req.body.body)
            if (recipe) {
